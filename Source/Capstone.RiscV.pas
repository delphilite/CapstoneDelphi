...
type
  riscv_op_type = Integer;
  Priscv_op_type = ^riscv_op_type;
...
type
  riscv_insn_group = Integer;
  Priscv_insn_group = ^riscv_insn_group;
...
type
  ...
  Priscv_op_mem = ^riscv_op_mem;
  Pcs_riscv_op = ^cs_riscv_op;
  Pcs_riscv = ^cs_riscv;
  ...
  cs_riscv_op = record
    type_: riscv_op_type;
    /// union op detail
    detail: cs_riscv_op_detail;
  end;

  cs_riscv = record
    need_effective_addr: Boolean;
    op_count: UInt8;
    operands: array[0..7] of cs_riscv_op;
  end;
