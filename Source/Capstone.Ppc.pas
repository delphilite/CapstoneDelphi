...
type
  ppc_insn_group = Integer;
  Pppc_insn_group = ^ppc_insn_group;
...
type
  ...
  Pppc_op_mem = ^ppc_op_mem;
  Pppc_op_crx = ^ppc_op_crx;
  Pcs_ppc_op = ^cs_ppc_op;
  Pcs_ppc = ^cs_ppc;
  ...
  cs_ppc_op_detail = record
    ...
    mem: ppc_op_mem);
      3: (/// operand with condition register
    crx: ppc_op_crx);
  end;
