...
type
  ...
  xcore_op_type = Integer;
  Pxcore_op_type = ^xcore_op_type;
...
type
  xcore_insn_group = Integer;
  Pxcore_insn_group = ^xcore_insn_group;
...
type
  ...
  Pxcore_op_mem = ^xcore_op_mem;
  Pcs_xcore_op = ^cs_xcore_op;
  Pcs_xcore = ^cs_xcore;
