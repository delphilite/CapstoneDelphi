...
type
  ...
  tricore_op_type = Integer;
  Ptricore_op_type = ^tricore_op_type;
...
/// TriCore instruction
type
  tricore_insn = Integer;
  Ptricore_insn = ^tricore_insn;
...
type
  tricore_insn_group = Integer;
  Ptricore_insn_group = ^tricore_insn_group;
...
type
  tricore_feature_t = Integer;
  Ptricore_feature_t = ^tricore_feature_t;
...
type
  ...
  Ptricore_op_mem = ^tricore_op_mem;
  Pcs_tricore_op = ^cs_tricore_op;
  Pcs_tricore = ^cs_tricore;

  /// Instruction's operand referring to memory
  /// This is associated with TRICORE_OP_MEM operand type above
  tricore_op_mem = record
    /// base register
    base: UInt8;
  ...
  /// Instruction operand
  cs_tricore_op = record
    /// operand type
    type_: tricore_op_type;
    /// union op detail
    detail: cs_tricore_op_detail;
  ...
  cs_tricore = record
    ...
    operands: array[0..7] of cs_tricore_op;
